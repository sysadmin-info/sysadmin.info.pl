...
Dodaj klucz publiczny (`~/.ssh/id_rsa.pub`) do swojego projektu GitLab w sekcji **Settings** > **Repository** > **Deploy Keys**.
...
4. Dodaj nową zmienną:
   - **Key**: `SSH_PRIVATE_KEY`
   - **Value**: Wklej zawartość swojego prywatnego klucza SSH (`~/.ssh/id_rsa`).
