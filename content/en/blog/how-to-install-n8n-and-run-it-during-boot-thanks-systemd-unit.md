---
title: How to install n8n and run it during boot thanks systemd unit 
date: 2023-12-21T11:00:00+00:00
description: How to install n8n and run it during boot thanks systemd unit 
draft: false
hideToc: false
enableToc: true
...
2. Put the below content into the file:
...
4. Execute the below script to make it work:

```bash
./n8n-install.sh
```

5. Check the IP address of the machine, where you execued the script using the below command:

```bash
hostnbame -I
```

6. Open the browser and paste the IP address and port

```
http://IP_ADDRESS:5678
```

7. Create login and password for n8n.

8. That's it. n8n is working. Enjoy!
