---
title: Installation and configuration of auditd
date: 2021-02-14T14:49:24+00:00
description: Installation and configuration of auditd
draft: false
hideToc: false
enableToc: true
...
<figcaption>Rules in /etc/audit/rules.d/audit.rules</figcaption>

```
#####################
# This is an example configuration suitable for most systems
# Before running with this configuration:
# - Remove or comment items that are not applicable
...
F dir=/bin -F success=0 -k unauthedfileacess
